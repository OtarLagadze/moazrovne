    ...
    <>
      <section>
        ...
        <p className={classes.importantMessage}>
          * --- გთხოვთ, დანიშნულებაში მიუთითოთ ოლიმპიადაში მონაწილე მოსწავლის სახელი, გვარი, კლასი, პირადი ნომერი (მოსწავლის ან მშობლის) და ქალაქის სახელი, სადაც გსურთ მონაწილეობის მიღება (თბილისი, ბათუმი, რუსთავი, ქუთაისი, ზუგდიდი).
